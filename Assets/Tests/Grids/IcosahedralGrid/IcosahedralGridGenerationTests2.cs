...
{
    [TestClass]
    public class IcosahedralGridGeneratorTests2
    {
        ...
        {
            var options = new Options() {Radius = 1f, Resolution = 0.5f};
        ...
        public void All_Old_Edges_Should_Be_Deleted()
        {
            var edgesLongerThanPoint5 = _gridGenerator.Edges
                                        .Where(edge => (edge.Vertices[0].Position - edge.Vertices[1].Position).magnitude > 0.5f)
                                        .ToList();
        ...
        [TestMethod]
        public void Should_Be_480_Edges()
        {
            var expectedNumberOfEdges = 480;
        ...
        [TestMethod]
        public void Should_Be_162_Vertices()
        {
            var expectedNumberOfVertices = 162;
        ...
        {
            var expectedVerticesOnEachEdge = Enumerable.Repeat(2, 480).ToList();
...
//        }
        ...
        [TestMethod]
        public void There_Should_Be_150_Vertices_With_Six_Edges()
        {
            var expectedNumberOfVertices = 150;
...
//        }
        ...
        [TestMethod]
        public void Vertices_Should_Hold_320_Distinct_Faces()
        {
            var expectedNumberOfDistinctFaces = 320;
        ...
        [TestMethod]
        public void Vertices_Should_Hold_480_Distinct_Edges()
        {
            var expectedNumberOfDistinctEdges = 480;
        ...
        [TestMethod]
        public void Edges_Should_Hold_320_Distinct_Faces()
        {
            var expectedNumberOfDistinctFaces = 320;
        ...
        [TestMethod]
        public void Edges_Should_Hold_162_Distinct_Vertices()
        {
            var expectedNumberOfDistinctVertices = 162;
        ...
        [TestMethod]
        public void Faces_Should_Hold_162_Distinct_Vertices()
        {
            var expectedNumberOfDistinctVertices = 162;
        ...
        [TestMethod]
        public void Faces_Should_Hold_480_Distinct_Edges()
        {
            var expectedNumberOfDistinctEdges = 480;
