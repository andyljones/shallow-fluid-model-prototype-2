...
namespace Tests.SimulatorTests.ShallowFluidSimulatorTests
{
    ...
    public class DifferenceOperatorTests
    {
        ...
        public void Create_Fake_Atmosphere_And_Simulator()
        {
            ...
            _fakeAtmo.Cells[0].Area = 3;
            _fakeAtmo.Cells[0].VelocityPotential = 4;
            _fakeAtmo.Cells[0].Streamfunction = 11;

            _fakeAtmo.Cells[1].Area = 2;
            _fakeAtmo.Cells[1].VelocityPotential = 8;
            _fakeAtmo.Cells[1].Streamfunction = -5;
